...
class HitDetails extends Component {
    ...
    getHits(id,word, index0){
        let url="https://pixabay.com/api/?key=16449759-50b988709d6f803fcf0dbcf42&id="+id;
  ...
  /*  getSecondHits(word, index0){
    ...
    render(){
                ...
                if(this.state.hit!=null){
                    console.log(++this.props.match.params.index0+"hit details");

            // console.log("cdt true");
                return(
                    
                    <HitItem hit= {this.state.hit}  id= {this.state.id_next} word={this.props.match.params.word} index0={++this.props.match.params.index0} etat={true} details={true}  />      
